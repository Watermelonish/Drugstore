...
module.exports = function UserAccount({ theUser, newUser, transactions, thetheUser }) {
  return (
      ...
      <div className="main justify-content-start userMain">
                ...
                <div class="collapse" id="collapseExample">
                  <div class="card card-body">
                    <form className="changeLoginBtn">
                      <p>Введите пароль</p>
                      <input name="passwordInput" type="text"></input>
                      <p>Введите новое имя</p>
                      <input name="loginInput" type="text"></input>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button
                    type="button"
                    class="btn deleteAccBtn btn-danger"
                    data-id={` ${theUser.id}`}
                  >
                    удалить
                  </button>
        ...
        <div className="transactionsContainer">
          {transactions.length == 0 ? (
            <p>
              Здесь пока пусто. Вы ещё ничего не заказали.{" "}
              <a defer href="/main">
                к покупкам
              </a>
            </p>
