...
module.exports = function Login({ theUser, newUser }) {
  ...
  return (
    <Layout newUser={newUser} theUser={theUser}>
              ...
              <div className="card w-75" key={`${drug.id}`} id={`${drug.id}`}>
                <div className="card-body">
                  ...
                  <a
                    href="#"
                    id={`${drug["Drugs.id"]}`}
                    className="btn btn-primary deleteBasket"
                  >
                    Удалить товар
                  </a>
                </div>
      ...
      <div className="basketSum">
        ...
        <p className="sumToShow">{`${sum}`} руб.</p>
      </div>
      <button
        type="button"
      ...
      <div className="toast-container position-fixed bottom-0 end-0 p-3">
        ...
        >
          ...
          <div className="toast-body">Товары уже едут к вам</div>
        </div>
      </div>
    </Layout>
  );
